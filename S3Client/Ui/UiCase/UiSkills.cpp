...
#define 	SCHEME_INI_SHEET			"UiSkillsSheet.ini"//"技能主窗口.ini"
#define 	SCHEME_INI_LIVE				"生活技能分页.ini"
#define 	SCHEME_INI_FIGHT			"UiSkillsLive.ini"//"战斗技能分页.ini"
#define 	SCHEME_INI_FIGHT_SUB_PAGE	"UiSkillsFightSub.ini"//"战斗技能细分页.ini"
