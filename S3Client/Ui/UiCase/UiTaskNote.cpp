...
#define 	SCHEME_INI_TASKNOTE			"UiTaskNote.ini"//"任务记事.ini"
#define 	SCHEME_INI_SYSTEM			"UiTaskNoteSysTem.ini"//"任务记事-系统任务分页.ini"
#define 	SCHEME_INI_PERSONAL			"UiTaskNotePerSoNal.ini"//"任务记事-个人记事分页.ini"
